...
blacksmith_launcher_exe_path="$wineprefix"
...
WINEPREFIX="$wineprefix" DXVK_HUD=1 WINEDLLOVERRIDES="d3d11=n;d3d10core=n;dxgi=n;d3d9=n" "$winebin/wine" "$blacksmith_launcher_exe_path/drive_c/Program Files/IRONMACE/Blacksmith/BlacksmithBootstrap.exe"